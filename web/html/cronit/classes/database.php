...
define ( 'DB_HOST', 'fundydb.alllwork.com' );
define ( 'DB_USER', 'fundy' );
define ( 'DB_PASS', 'a254984517tu' );
define ( 'DB_CHAR', 'utf8' );
class Database extends PDO {
	...
	public static function get($group = false) {
		...
		$instance = new Database ( "$type:host=$host;charset=$char", $user, $pass );
	...
	public function insertIfNew($table, $array) {
		$cmd = "ID FROM $table
		WHERE ";
		...
		$cmd = $cmd . "LIMIT 1";
		$rows = $this->select ( str_replace ( "WHERE AND", "WHERE", $cmd ), $array );
		if (count ( $rows ) < 1) {
